        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              <h2 className="text-3xl font-bold text-gray-900">
                Your Own{" "}
                <span className="text-green-700">Kitchen Garden</span>
              </h2>
      ...
      <section className="bg-green-700 py-20 text-center text-white">
        <div className="mx-auto max-w-3xl px-4">
          ...
          <p className="mt-4 text-green-100">
            Join hundreds of families who already enjoy chemical-free, farm-fresh
            produce every week. Start your journey today.
          </p>
